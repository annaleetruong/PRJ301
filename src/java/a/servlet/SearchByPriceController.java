    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (priceMinParam != null && priceMaxParam != null) {
                List<ProductDTO> list = dao.getListProductByPrice(Double.parseDouble(priceMinParam), Double.parseDouble(priceMaxParam));
                request.setAttribute("LIST_PRODUCT", list);
            } else {
                List<ProductDTO> list = dao.getListProductByPrice(Double.parseDouble(priceParam));
                request.setAttribute("LIST_PRODUCT", list);
            }
